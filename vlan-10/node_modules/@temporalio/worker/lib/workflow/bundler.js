    ...
    async bundle(inputFilesystem, outputFilesystem, entry, distDir) {
        ...
        const options = {
            ...
            plugins: [
                ...
                new webpack_1.NormalModuleReplacementPlugin(/[\\/](?:@temporalio|contrib)[\\/]interceptors-opentelemetry[\\/](?:src|lib)[\\/]workflow[\\/]workflow-imports\.[jt]s$/, './workflow-imports-impl.js'),
            ],
